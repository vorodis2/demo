...
export class OWord {
    constructor(par, fun, sah, kol) {
        ...
        this.sah = sah
        this.kol = kol
        if(this.sah==undefined)this.sah = 64//шустей но не точней 64 норм
        if(this.kol==undefined)this.kol = 8//шустей но не точней 4 норм   кол ращзщз физики за иторацию 
        this.pause = false
        ...
        this.init = function() {
            ...
            this.phNiz =  this.setOToBody({ mass: 0, arrShepes: [] })
